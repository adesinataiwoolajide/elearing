                        ...
                        <div class="col-md-12 dt-masonry__item">
                            <div class="dt-card">
                                ...
                                <ol class="mb-0 breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('submission.index')}}">View Submission</a></li>

                                    {{-- <li class="breadcrumb-item"><a href="{{route('solution.create')}}">View Course solution</a></li> --}}
                                                    ...
                                                    <tr class="gradeX">
                                                        <td>{{$y}}
                                                            {{-- @if (auth()->user()->hasPermissionTo('Delete Assignment') OR
                                                                (Gate::allows('Administrator', auth()->user())))
                                                                <a href="{{route('assignment.delete', $solutions->assignment_id)}}"
                                                                    class=""
                                                                    onclick="return(confirmToDelete());" >
                                                                <i class="fa fa-trash-o"></i></a>
                                                            @endif
                                                            @if (auth()->user()->hasRole('Staff'))
                                                                <a href="{{route('assignment.edit', $solutions->assignment_id)}}"
                                                                    class="" onclick="">
                                                            ...
                                                            @if (auth()->user()->hasRole('Student'))
                                                                <a href="{{route('assignment.solution', $solutions->assignment_id)}}"
                                                                    class="" onclick="">
                                                        ...
                                                        {{-- <td>{{$solutions->course->course_title}}</td>
                                                        <td>{{$solutions->question}}</td>
                                                        <td>{{$solutions->marks}}</td>
                                                        <td>{{$solutions->submission_date}}</td>
                                                        <td>{{$solutions->user->name}}</td>
                                                        <td>{{$solutions->program}}</td>
                                                        <td>{{$solutions->level}}</td> --}}
