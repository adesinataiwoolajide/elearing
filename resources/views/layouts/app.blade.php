                    ...
                    <div class="dt-brand">
                        ...
                        <span class="dt-brand__logo">
                            <a class="dt-brand__logo-link" href="">
                                <img class="dt-brand__logo-img d-none d-sm-inline-block" src="{{asset('assets/images/Oke-ogun-poly.jpeg')}}" alt="MFMCFUI">
                                <img class="dt-brand__logo-symbol d-sm-none" src="{{asset('assets/images/Oke-ogun-poly.jpeg')}}" alt="MFMCFUI">
                            </a>
                        </span>
                        <!-- /brand logo -->
